        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseWorks_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThesisVerifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ThesisVerifications_Theses_ThesisId",
                        column: x => x.ThesisId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Description = table.Column<string>(type: "text", nullable: false),
                    ThesisVerificationId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Violations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Violations_ThesisVerifications_ThesisVerificationId",
                        column: x => x.ThesisVerificationId,
                        principalTable: "ThesisVerifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ThesisVerifications_ThesisId",
                table: "ThesisVerifications",
                column: "ThesisId");

            migrationBuilder.CreateIndex(
                name: "IX_Violations_ThesisVerificationId",
                table: "Violations",
                column: "ThesisVerificationId");
        }
